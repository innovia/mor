...
function bind_class_description_preview() {
	$('.class_desc').bind('click', function(event) {
		...
		var reinstate_link = '<br /><h3><a href="#" id="reinstate_class" class="person_preview_links"><img src="/images/Refresh.gif" alt="Cancel Class">Reinstate Class</a></h3><br />';
		var cancel_link = '<br /><h3><a href="#" id="cancel_class" class="person_preview_links"><img src="/images/door_cancel.png" alt="Cancel Class">Cancel Class</a></h3><br />';
		var toggle_link;
